...
const MuiLoadingButton = () => {
    ...
    return (
        <Stack spacing={2} direction='row' p={6}>
            ...
            <LoadingButton loading={open} variant='outlined' loadingPosition='start' startIcon={<Save />} onClick={() => setOpen(true)}>Save</LoadingButton>
            <LoadingButton loading={open} variant='outlined' loadingPosition='start' startIcon={<Check />} onClick={() => setOpen(true)}>Save</LoadingButton>
        </Stack>
    )
}
